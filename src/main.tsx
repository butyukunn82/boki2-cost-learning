...
import './styles/manufacturing-cost-report.css'
import './styles/job-order-lab.css'
import './styles/process-lab.css'
import './styles/process-method-lab.css'
import './styles/additional-material-lab.css'
import './styles/spoilage-process-lab.css'
import './styles/normal-loss-allocation.css'
import './styles/group-grade-lab.css'
import './styles/department-lab.css'
import './styles/standard-cost-card.css'
import './styles/variance-lab.css'
import './styles/labor-variance-lab.css'
...
import './styles/misconception-review.css'
